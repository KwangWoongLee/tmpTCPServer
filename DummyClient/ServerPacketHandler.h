...
public:
	...
	static SendBufferRef MakeSendBuffer(Protocol::C_BROADCAST_ROOM& pkt) { return MakeSendBuffer(pkt, PKT_C_BROADCAST_ROOM); }
	static SendBufferRef MakeSendBuffer(Protocol::C_PONG& pkt) { return MakeSendBuffer(pkt, PKT_C_PONG); }
	static SendBufferRef MakeSendBuffer(Protocol::C_ACTION& pkt) { return MakeSendBuffer(pkt, PKT_C_ACTION); }
	static SendBufferRef MakeSendBuffer(Protocol::C_ATTACK& pkt) { return MakeSendBuffer(pkt, PKT_C_ATTACK); }
	static SendBufferRef MakeSendBuffer(Protocol::C_EXPLODE_BOMB& pkt) { return MakeSendBuffer(pkt, PKT_C_EXPLODE_BOMB); }
